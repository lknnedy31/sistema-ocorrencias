...
🖥️ Demonstração
<!-- Adicione aqui um print da tela do sistema rodando no terminal, ou um GIF curto mostrando o cadastro e a listagem de uma ocorrência --> <!-- Exemplo: ![demo](./assets/demo.gif) -->
⚙️ Funcionalidades
...
Kauã Kennedy Carneiro Araujo Estudante de Análise e Desenvolvimento de Sistemas (ADS) — UCSAL